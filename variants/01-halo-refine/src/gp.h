...
#define GP_LIST(GPA) \
    ...
    GPA(int,  GdipSetPenDashStyle,       (GpPen*, int dashStyle)) \
    GPA(int,  GdipCreateFontFamilyFromName, (const wchar_t*, GpFontCollection*, GpFontFamily**)) \
    GPA(int,  GdipCreateFont,            (GpFontFamily*, float emSize, int style, int unit, GpFont**)) \
