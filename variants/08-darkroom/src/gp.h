...
enum {
    ...
    GP_CAP_ROUND      = 2,     // LineCapRound / DashCapRound
};
...
#define GP_LIST(GPA) \
    ...
    GPA(int,  GdipDrawArcI,              (GpGraphics*, GpPen*, int x, int y, int w, int h, float startAngle, float sweepAngle)) \
    GPA(int,  GdipSetPenLineCap197819,   (GpPen*, int startCap, int endCap, int dashCap)) \
